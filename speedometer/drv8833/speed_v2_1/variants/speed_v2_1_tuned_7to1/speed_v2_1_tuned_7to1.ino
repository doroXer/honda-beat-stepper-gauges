...
/*
  Honda Beat Speedometer v2.1 - analyzed parameter test
  ホンダビート スピードメーター v2.1 - 解析パラメータ実車テスト

  Base / ベース:
    meter/speed/speed_v2.1/speed_v2_1/speed_v2_1.ino
  ...
  Changed parameters / 変更パラメータ:
    TARGET UP/DOWN       20/45    -> 45/60
    VIRTUAL VEL UP/DOWN  500/500  -> 500/500 (unchanged)
    VIRTUAL ACC UP/DOWN  6000/6000-> 6000/6000 (unchanged)
    STOP BAND            3        -> 3 (unchanged)
    MOTOR MAX SPEED      3600     -> 900 microstep/s
    MOTOR ACCEL          9600     -> 8000 microstep/s^2
    Control interval     50 ms    -> 50 ms (unchanged)
*/
...
const byte DISPLAY_FILTER_OLD=7,DISPLAY_FILTER_NEW=1;
